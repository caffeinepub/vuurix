...
import type { Order as _Order, OrderId as _OrderId, OrderItem as _OrderItem, ProductId as _ProductId, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string, arg5: Array<string>, arg6: Array<string>): Promise<ProductId> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: Array<OrderItem>, arg1: bigint): Promise<OrderId> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrder(to_candid_vec_n3(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: Array<string>, arg7: Array<string>): Promise<void> {
        if (this.processError) {
            try {
